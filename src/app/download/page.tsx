  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (downloadResponse.ok) {
        ...
        a.href = url;
        a.download = `Henna-Album-Sapir-Idan-18-09-2025.zip`;
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              כאן תוכלו להוריד את כל התמונות והסרטונים מהחינה שלנו באיכות הגבוהה ביותר
            </p>
          </div>
...
אני פונה אליך לגבי גישה לתמונות החינה שלנו.

*פרטי הזוג:* ${coupleNames}
*תאריך החינה:* ${hennaDate}
*זמן ניסיון הגישה:* ${accessTime}

*הסיבה:* אני צריך קוד גישה להורדת התמונות והסרטונים מהחינה שלנו.
