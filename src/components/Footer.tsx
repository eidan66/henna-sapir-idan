...
export const Footer: React.FC = () => (
  <footer className="henna-gradient border-t border-gold-200 text-center py-6 sm:py-8 text-gray-700 px-4">
    ...
    <div className="flex flex-col items-center mt-3 mb-2">
      <a
        href="https://wa.me/972505877179?text=Hi%20Idan%2C%20I%20want%20my%20own%20henna%20album%20website!"
        target="_blank"
        rel="noopener noreferrer"
