...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-50 via-white to-gold-50" dir="rtl">
      {/* Header */}
      <header className="henna-gradient border-b border-gold-200 sticky top-0 z-50 glass-effect">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href={createPageUrl("Gallery")} className="flex items-center gap-2 sm:gap-4 md:gap-6 group">
              ...
              <div className="flex-shrink-0 min-w-0">
                ...
                <p className="text-xs sm:text-sm text-gray-600 font-medium text-center whitespace-nowrap">זכרונות מהחינה שלנו</p>
                <div className="relative">
                  <p className="text-xs sm:text-sm text-gray-600 font-medium text-center relative z-10 whitespace-nowrap">
                    <span className="text-gold-600 font-semibold drop-shadow-sm">18-09-2025</span>
                  </p>
                  <WeddingDateConfetti />
                </div>
              </div>
